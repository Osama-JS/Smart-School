...
export default function FollowupBooksReport({ 
    ...
    const handleDownloadPDF = async () => {
        // Prevent PDF generation for very large datasets (all teachers + >15 days)
        if (!selectedTeacher?.value) {
            const startStr = startDate || periodStart;
            const endStr = endDate || periodEnd;
            if (startStr && endStr) {
                ...
                if (diffDays > 15) {
                    Swal.fire({
                        icon: 'warning',
                        title: 'نطاق زمني كبير جداً',
                        text: 'لا يمكن تصدير التقرير كملف PDF لجميع المعلمين لنطاق زمني يتجاوز 15 يوماً دفعة واحدة لتجنب الضغط على الخادم. يرجى تضييق النطاق الزمني أو اختيار معلم محدد.',
