...
export default function UsersCreate({ roles, branches = [], isAdmin = false }) {
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <h1 className="text-2xl md:text-3xl font-black text-dark-900 dark:text-white tracking-tight">إضافة مستخدم جديد</h1>
                        </div>
                        <p className="text-primary-700/80 dark:text-primary-300/80 text-sm font-semibold pr-10">إدخال بيانات حساب المستخدم وتعيين الصلاحية والفرع</p>
                    </div>
                </div>
            </div>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="p-6 md:p-8 space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input type="text" required
                                        placeholder="الاسم الثلاثي أو الثنائي باللغة العربية"
                            ...
                            <div>
                                <label className="block text-sm font-bold text-dark-900 mb-2">كلمة المرور <span className="text-accent-500">*</span></label>
                                <div className="relative">
                    ...
                    <div className="px-6 py-5 bg-slate-50 border-t border-slate-100 flex justify-end gap-3">
                        ...
                        <button type="submit" disabled={processing} className="flex items-center gap-2 px-6 py-2.5 text-sm font-bold text-white bg-primary-500 rounded-2xl hover:bg-primary-600 hover:shadow-lg hover:shadow-primary-500/10 transition-all disabled:opacity-60">
                            <Save size={16} /> {processing ? 'جاري الحفظ...' : 'حفظ المستخدم'}
                        </button>
                    </div>
                </form>
            </div>
