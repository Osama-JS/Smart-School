...
<body class="p-4 sm:p-8">
    ...
    <table class="w-full text-right border-collapse border border-black/20 mt-2">
        <thead>
            <tr>
                <th class="bg-slate-100 p-2 font-bold w-24 text-center border border-black/20 text-slate-800">اليوم / الحصة</th>
                @foreach($periods as $period)
                    <th class="bg-slate-100 p-2 font-bold text-center border border-black/20 text-slate-800 w-32">
                        <div class="mb-1 text-[13px] font-black">{{ $period->period_name }}</div>
                        <div class="text-[10px] text-slate-600 font-bold" dir="ltr">
        ...
        <tbody>
            @foreach($workingDays as $day)
                <tr>
                    <td class="bg-slate-100 p-2 font-black text-slate-800 text-center border border-black/20">
