            ...
            <div className="p-6">
                ...
                <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-6">
                    ...
                    <ul className="list-disc list-inside text-sm text-blue-700 space-y-1">
                        <li><strong>توليد الأرقام الأكاديمية:</strong> سيقوم النظام تلقائياً بتوليد رقم أكاديمي مميز (كاسم مستخدم) وكلمة مرور آمنة لكل طالب.</li>
                        <li><strong>تطابق البيانات:</strong> يجب كتابة (المرحلة الدراسية، الصف الدراسي، والشعبة) بدقة لتسجيل الطالب بنجاح، وإلا سيتم استبعاده.</li>
                        <li><strong>سجل الأخطاء:</strong> سيتم إبلاغك بالسجلات الخاطئة إن وجدت.</li>
                    </ul>
                </div>

                <div className="mb-6 flex justify-center">
                    <a 
                        href={route('academic.students.template')} 
